      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm p-5">
            ...
            <div className="text-3xl font-bold text-[#2563eb]">{formatCurrency(totalValueQuoted)}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden">
            ...
            {recentEstimates.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center px-6">
                ...
                <Link href="/chat" className="mt-3 text-xs font-semibold text-[#2563eb] hover:underline">Create your first estimate →</Link>
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 ml-4 shrink-0">
                        {conv.total ? (
                          <span className="text-sm font-semibold text-[#2563eb]">{formatCurrency(conv.total)}</span>
                        ) : (
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              ...
              <Link href="/approvals" className="text-xs font-semibold text-[#2563eb] hover:underline">View all</Link>
            </div>
                    ...
                    <div key={approval.id} className="px-5 py-3.5">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="text-right shrink-0">
                          {amount && <div className="text-sm font-semibold text-[#2563eb]">{amount}</div>}
